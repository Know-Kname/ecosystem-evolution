...
# from the Civilian Windows user profile for backup and analysis.
#
# USAGE:
...
#   5. Files will be collected to C:\Users\Civilian\ConfigBackup
#

$CollectionPath = "C:\Users\Civilian\ConfigBackup"
...
Write-Host "4. Upload ZIP to GitHub repository: profiles/Civilian/" -ForegroundColor White
Write-Host ""
